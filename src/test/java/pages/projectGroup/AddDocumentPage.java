...
public class AddDocumentPage extends BasePage {
	...
	By btnLoadDocument_ExternalLink = By.xpath("//div[(@id='radReportConfigPanels')]//following::span[@id='radReportConfigPanels_i0_i0_btnSave']");
	...
	public void addDocument(Map<String, String> map, String testcaseName) {
		...
		try {
			...
			throw new RuntimeException("STEP 6:  User can not Click on Add Document");
		}
		try {
